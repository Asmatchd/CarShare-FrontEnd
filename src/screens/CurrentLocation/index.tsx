...
const Map: React.FC = ({ route }) => {
  ...
  function showRiderProfile() {
    navigation.navigate('RiderProfile', { rider: route.params.rider });
  }
  function showMyRides() {
    navigation.navigate('RiderRidesHistory', { rider: route.params.rider });
  }
  function showMySecduleRides() {
    navigation.navigate('RiderSecduledRides', { rider: route.params.rider });
  }
  function Llogout() {
  ...
  return (
    <S.Container>
      ...
      <S.OptionsContainer>
        <S.LeftOptions>
          <MapButton icon={profile} onPress={showRiderProfile} />
